...
**Function:** `test_capability_matches_exact`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_capabilities.py::TestCapability::test_capability_matches_exact -v --tb=short
```
...
*Sheet TB-TEST-CAP-003 | TelsonBase v11.0.1 | March 8, 2026*
