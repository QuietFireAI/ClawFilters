# TB-TEST-SCRT-011 - TestSecretValue · `test_format_is_safe`

**Sheet ID:** TB-TEST-SCRT-011
**Series:** Individual Test Evidence
**Test File:** `tests/test_secrets.py`
**Class:** `TestSecretValue`
**Function:** `test_format_is_safe`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_secrets.py::TestSecretValue::test_format_is_safe -v --tb=short
```
...
*Sheet TB-TEST-SCRT-011 | TelsonBase v11.0.3 | March 8, 2026*
