# TB-TEST-SCRT-027 - TestSecretsProvider · `test_source_tracking`

**Sheet ID:** TB-TEST-SCRT-027
**Series:** Individual Test Evidence
**Test File:** `tests/test_secrets.py`
**Class:** `TestSecretsProvider`
**Function:** `test_source_tracking`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_secrets.py::TestSecretsProvider::test_source_tracking -v --tb=short
```
...
*Sheet TB-TEST-SCRT-027 | TelsonBase v11.0.1 | March 8, 2026*
