# TB-TEST-SCRT-001 - TestSecretValue · `test_str_is_redacted`

**Sheet ID:** TB-TEST-SCRT-001
**Series:** Individual Test Evidence
**Test File:** `tests/test_secrets.py`
**Class:** `TestSecretValue`
**Function:** `test_str_is_redacted`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_secrets.py::TestSecretValue::test_str_is_redacted -v --tb=short
```
...
*Sheet TB-TEST-SCRT-001 | TelsonBase v11.0.3 | March 8, 2026*
