# TB-TEST-SCRT-008 - TestSecretValue · `test_bool_falsy`

**Sheet ID:** TB-TEST-SCRT-008
**Series:** Individual Test Evidence
**Test File:** `tests/test_secrets.py`
**Class:** `TestSecretValue`
**Function:** `test_bool_falsy`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_secrets.py::TestSecretValue::test_bool_falsy -v --tb=short
```
...
*Sheet TB-TEST-SCRT-008 | TelsonBase v11.0.3 | March 8, 2026*
