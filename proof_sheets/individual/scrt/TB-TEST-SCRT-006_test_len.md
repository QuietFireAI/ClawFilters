# TB-TEST-SCRT-006 - TestSecretValue · `test_len`

**Sheet ID:** TB-TEST-SCRT-006
...
```bash
docker compose exec mcp_server python -m pytest tests/test_secrets.py::TestSecretValue::test_len -v --tb=short
```
...
*Sheet TB-TEST-SCRT-006 | TelsonBase v11.0.1 | March 8, 2026*
