# TB-TEST-SCRT-010 - TestSecretValue · `test_fstring_is_safe`

**Sheet ID:** TB-TEST-SCRT-010
**Series:** Individual Test Evidence
**Test File:** `tests/test_secrets.py`
**Class:** `TestSecretValue`
**Function:** `test_fstring_is_safe`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_secrets.py::TestSecretValue::test_fstring_is_safe -v --tb=short
```
...
*Sheet TB-TEST-SCRT-010 | TelsonBase v11.0.1 | March 8, 2026*
