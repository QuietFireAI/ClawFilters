# TB-TEST-SCRT-018 - TestSecretsProvider · `test_docker_secret_overrides_env_var`

**Sheet ID:** TB-TEST-SCRT-018
...
> Docker secret overrides env var
...
```bash
docker compose exec mcp_server python -m pytest tests/test_secrets.py::TestSecretsProvider::test_docker_secret_overrides_env_var -v --tb=short
```
