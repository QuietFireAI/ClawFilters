# TB-TEST-OCL-037 - TestKillSwitch · `test_kill_switch_survives_cache_clear`

**Sheet ID:** TB-TEST-OCL-037
...
> Kill switch survives cache clear
...
```bash
docker compose exec mcp_server python -m pytest tests/test_openclaw.py::TestKillSwitch::test_kill_switch_survives_cache_clear -v --tb=short
```
