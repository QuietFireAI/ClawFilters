# TB-TEST-OCL-053 — TestQueryMethods · `test_list_instances`

**Sheet ID:** TB-TEST-OCL-053
...
```bash
docker compose exec mcp_server python -m pytest tests/test_openclaw.py::TestQueryMethods::test_list_instances -v --tb=short
```
...
*Sheet TB-TEST-OCL-053 | TelsonBase v11.0.1 | March 8, 2026*
