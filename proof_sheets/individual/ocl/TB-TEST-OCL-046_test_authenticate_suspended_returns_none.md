# TB-TEST-OCL-046 — TestAuthentication · `test_authenticate_suspended_returns_none`

**Sheet ID:** TB-TEST-OCL-046
...
> Authenticate suspended returns none
...
```bash
docker compose exec mcp_server python -m pytest tests/test_openclaw.py::TestAuthentication::test_authenticate_suspended_returns_none -v --tb=short
```
