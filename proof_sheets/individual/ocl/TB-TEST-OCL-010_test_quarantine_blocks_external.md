# TB-TEST-OCL-010 - TestGovernancePipeline · `test_quarantine_blocks_external`

**Sheet ID:** TB-TEST-OCL-010
**Series:** Individual Test Evidence
**Test File:** `tests/test_openclaw.py`
**Class:** `TestGovernancePipeline`
**Function:** `test_quarantine_blocks_external`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_openclaw.py::TestGovernancePipeline::test_quarantine_blocks_external -v --tb=short
```
...
*Sheet TB-TEST-OCL-010 | TelsonBase v11.0.3 | March 8, 2026*
