# TB-TEST-OCL-035 — TestKillSwitch · `test_suspend_nonexistent_fails`

**Sheet ID:** TB-TEST-OCL-035
**Series:** Individual Test Evidence
**Test File:** `tests/test_openclaw.py`
**Class:** `TestKillSwitch`
**Function:** `test_suspend_nonexistent_fails`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_openclaw.py::TestKillSwitch::test_suspend_nonexistent_fails -v --tb=short
```
...
*Sheet TB-TEST-OCL-035 | TelsonBase v11.0.1 | March 8, 2026*
