# TB-TEST-OCL-018 - TestGovernancePipeline · `test_allowlist_enforcement`

**Sheet ID:** TB-TEST-OCL-018
**Series:** Individual Test Evidence
**Test File:** `tests/test_openclaw.py`
**Class:** `TestGovernancePipeline`
**Function:** `test_allowlist_enforcement`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_openclaw.py::TestGovernancePipeline::test_allowlist_enforcement -v --tb=short
```
...
*Sheet TB-TEST-OCL-018 | TelsonBase v11.0.3 | March 8, 2026*
