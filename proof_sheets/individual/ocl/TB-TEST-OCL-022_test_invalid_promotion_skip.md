# TB-TEST-OCL-022 - TestTrustLevels · `test_invalid_promotion_skip`

**Sheet ID:** TB-TEST-OCL-022
**Series:** Individual Test Evidence
**Test File:** `tests/test_openclaw.py`
**Class:** `TestTrustLevels`
**Function:** `test_invalid_promotion_skip`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_openclaw.py::TestTrustLevels::test_invalid_promotion_skip -v --tb=short
```
...
*Sheet TB-TEST-OCL-022 | TelsonBase v11.0.3 | March 8, 2026*
