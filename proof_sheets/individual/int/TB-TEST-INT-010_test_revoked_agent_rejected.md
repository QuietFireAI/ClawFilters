# TB-TEST-INT-010 - TestCrossAgentMessaging · `test_revoked_agent_rejected`

**Sheet ID:** TB-TEST-INT-010
**Series:** Individual Test Evidence
**Test File:** `tests/test_integration.py`
**Class:** `TestCrossAgentMessaging`
**Function:** `test_revoked_agent_rejected`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_integration.py::TestCrossAgentMessaging::test_revoked_agent_rejected -v --tb=short
```
...
*Sheet TB-TEST-INT-010 | TelsonBase v11.0.3 | March 8, 2026*
