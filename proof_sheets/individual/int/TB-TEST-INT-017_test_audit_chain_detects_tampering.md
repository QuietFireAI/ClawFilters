# TB-TEST-INT-017 - TestAuditChain · `test_audit_chain_detects_tampering`

**Sheet ID:** TB-TEST-INT-017
**Series:** Individual Test Evidence
**Test File:** `tests/test_integration.py`
**Class:** `TestAuditChain`
**Function:** `test_audit_chain_detects_tampering`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_integration.py::TestAuditChain::test_audit_chain_detects_tampering -v --tb=short
```
...
*Sheet TB-TEST-INT-017 | TelsonBase v11.0.3 | March 8, 2026*
