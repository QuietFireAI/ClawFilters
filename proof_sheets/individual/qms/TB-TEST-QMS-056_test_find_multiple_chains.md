# TB-TEST-QMS-056 - TestFindChains · `test_find_multiple_chains`

**Sheet ID:** TB-TEST-QMS-056
**Series:** Individual Test Evidence
**Test File:** `tests/test_qms.py`
**Class:** `TestFindChains`
**Function:** `test_find_multiple_chains`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestFindChains::test_find_multiple_chains -v --tb=short
```
...
*Sheet TB-TEST-QMS-056 | TelsonBase v11.0.1 | March 8, 2026*
