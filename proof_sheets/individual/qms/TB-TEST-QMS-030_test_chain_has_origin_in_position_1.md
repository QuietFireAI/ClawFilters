...
**Function:** `test_chain_has_origin_in_position_1`
**Status:** VERIFIED
...
> Chain has origin in position 1
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestBuildChain::test_chain_has_origin_in_position_1 -v --tb=short
```
...
*Sheet TB-TEST-QMS-030 | TelsonBase v11.0.1 | March 8, 2026*
