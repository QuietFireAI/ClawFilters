# TB-TEST-QMS-051 — TestParseChain · `test_parse_preserves_raw`

**Sheet ID:** TB-TEST-QMS-051
**Series:** Individual Test Evidence
**Test File:** `tests/test_qms.py`
**Class:** `TestParseChain`
**Function:** `test_parse_preserves_raw`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestParseChain::test_parse_preserves_raw -v --tb=short
```
...
*Sheet TB-TEST-QMS-051 | TelsonBase v11.0.1 | March 8, 2026*
