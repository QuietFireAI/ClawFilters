...
**Function:** `test_system_halt_constant`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestConstantsAndEnums::test_system_halt_constant -v --tb=short
```
...
*Sheet TB-TEST-QMS-105 | TelsonBase v11.0.1 | March 8, 2026*
