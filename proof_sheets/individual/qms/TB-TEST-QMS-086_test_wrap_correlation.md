# TB-TEST-QMS-086 - TestWrapQualifier · `test_wrap_correlation`

**Sheet ID:** TB-TEST-QMS-086
**Series:** Individual Test Evidence
**Test File:** `tests/test_qms.py`
**Class:** `TestWrapQualifier`
**Function:** `test_wrap_correlation`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestWrapQualifier::test_wrap_correlation -v --tb=short
```
...
*Sheet TB-TEST-QMS-086 | TelsonBase v11.0.1 | March 8, 2026*
