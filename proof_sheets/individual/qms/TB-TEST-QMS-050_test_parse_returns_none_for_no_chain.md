...
**Function:** `test_parse_returns_none_for_no_chain`
**Status:** VERIFIED
...
> Parse returns none for no chain
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestParseChain::test_parse_returns_none_for_no_chain -v --tb=short
```
...
*Sheet TB-TEST-QMS-050 | TelsonBase v11.0.1 | March 8, 2026*
