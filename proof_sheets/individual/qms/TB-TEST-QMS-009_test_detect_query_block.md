# TB-TEST-QMS-009 - TestBlockDetection · `test_detect_query_block`

**Sheet ID:** TB-TEST-QMS-009
**Series:** Individual Test Evidence
**Test File:** `tests/test_qms.py`
**Class:** `TestBlockDetection`
**Function:** `test_detect_query_block`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestBlockDetection::test_detect_query_block -v --tb=short
```
...
*Sheet TB-TEST-QMS-009 | TelsonBase v11.0.3 | March 8, 2026*
