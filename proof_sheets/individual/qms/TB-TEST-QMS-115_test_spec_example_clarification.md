...
**Function:** `test_spec_example_clarification`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestSpecExamples::test_spec_example_clarification -v --tb=short
```
...
*Sheet TB-TEST-QMS-115 | TelsonBase v11.0.1 | March 8, 2026*
