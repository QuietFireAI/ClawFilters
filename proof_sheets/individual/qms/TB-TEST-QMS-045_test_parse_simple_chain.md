# TB-TEST-QMS-045 — TestParseChain · `test_parse_simple_chain`

**Sheet ID:** TB-TEST-QMS-045
**Series:** Individual Test Evidence
**Test File:** `tests/test_qms.py`
**Class:** `TestParseChain`
**Function:** `test_parse_simple_chain`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestParseChain::test_parse_simple_chain -v --tb=short
```
...
*Sheet TB-TEST-QMS-045 | TelsonBase v11.0.1 | March 8, 2026*
