# TB-TEST-QMS-096 - TestLegacyCompatibility · `test_format_qms_legacy`

**Sheet ID:** TB-TEST-QMS-096
**Series:** Individual Test Evidence
**Test File:** `tests/test_qms.py`
**Class:** `TestLegacyCompatibility`
**Function:** `test_format_qms_legacy`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestLegacyCompatibility::test_format_qms_legacy -v --tb=short
```
...
*Sheet TB-TEST-QMS-096 | TelsonBase v11.0.1 | March 8, 2026*
