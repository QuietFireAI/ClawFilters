...
**Function:** `test_roundtrip_halt_chain`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestParseChain::test_roundtrip_halt_chain -v --tb=short
```
...
*Sheet TB-TEST-QMS-054 | TelsonBase v11.0.3 | March 8, 2026*
