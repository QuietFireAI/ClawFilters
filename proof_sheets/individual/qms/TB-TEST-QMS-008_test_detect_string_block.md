# TB-TEST-QMS-008 - TestBlockDetection · `test_detect_string_block`

**Sheet ID:** TB-TEST-QMS-008
**Series:** Individual Test Evidence
**Test File:** `tests/test_qms.py`
**Class:** `TestBlockDetection`
**Function:** `test_detect_string_block`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestBlockDetection::test_detect_string_block -v --tb=short
```
...
*Sheet TB-TEST-QMS-008 | TelsonBase v11.0.3 | March 8, 2026*
