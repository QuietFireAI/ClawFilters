# TB-TEST-QMS-088 — TestWrapQualifier · `test_wrap_identifier`

**Sheet ID:** TB-TEST-QMS-088
**Series:** Individual Test Evidence
**Test File:** `tests/test_qms.py`
**Class:** `TestWrapQualifier`
**Function:** `test_wrap_identifier`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestWrapQualifier::test_wrap_identifier -v --tb=short
```
...
*Sheet TB-TEST-QMS-088 | TelsonBase v11.0.1 | March 8, 2026*
