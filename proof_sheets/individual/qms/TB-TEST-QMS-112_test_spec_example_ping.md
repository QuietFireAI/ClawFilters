# TB-TEST-QMS-112 - TestSpecExamples · `test_spec_example_ping`

**Sheet ID:** TB-TEST-QMS-112
**Series:** Individual Test Evidence
**Test File:** `tests/test_qms.py`
**Class:** `TestSpecExamples`
**Function:** `test_spec_example_ping`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestSpecExamples::test_spec_example_ping -v --tb=short
```
...
*Sheet TB-TEST-QMS-112 | TelsonBase v11.0.1 | March 8, 2026*
