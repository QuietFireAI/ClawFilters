...
**Function:** `test_detect_origin_with_numeric_id`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestBlockDetection::test_detect_origin_with_numeric_id -v --tb=short
```
...
*Sheet TB-TEST-QMS-002 | TelsonBase v11.0.3 | March 8, 2026*
