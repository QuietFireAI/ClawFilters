# TB-TEST-QMS-023 - TestQMSBlock · `test_numeric_inner_value`

**Sheet ID:** TB-TEST-QMS-023
**Series:** Individual Test Evidence
**Test File:** `tests/test_qms.py`
**Class:** `TestQMSBlock`
**Function:** `test_numeric_inner_value`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestQMSBlock::test_numeric_inner_value -v --tb=short
```
...
*Sheet TB-TEST-QMS-023 | TelsonBase v11.0.3 | March 8, 2026*
