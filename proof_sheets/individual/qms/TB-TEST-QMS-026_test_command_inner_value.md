# TB-TEST-QMS-026 - TestQMSBlock · `test_command_inner_value`

**Sheet ID:** TB-TEST-QMS-026
**Series:** Individual Test Evidence
**Test File:** `tests/test_qms.py`
**Class:** `TestQMSBlock`
**Function:** `test_command_inner_value`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_qms.py::TestQMSBlock::test_command_inner_value -v --tb=short
```
...
*Sheet TB-TEST-QMS-026 | TelsonBase v11.0.1 | March 8, 2026*
