...
**Function:** `test_jwt_algorithm_configured`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_security_battery.py::TestNetworkSecurity::test_jwt_algorithm_configured -v --tb=short
```
...
*Sheet TB-TEST-SEC-062 | TelsonBase v11.0.1 | March 8, 2026*
