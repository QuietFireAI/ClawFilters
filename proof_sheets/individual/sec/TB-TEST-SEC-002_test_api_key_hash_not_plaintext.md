...
**Function:** `test_api_key_hash_not_plaintext`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_security_battery.py::TestAuthSecurity::test_api_key_hash_not_plaintext -v --tb=short
```
...
*Sheet TB-TEST-SEC-002 | TelsonBase v11.0.1 | March 8, 2026*
