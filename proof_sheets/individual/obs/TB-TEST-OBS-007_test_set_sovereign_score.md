# TB-TEST-OBS-007 — TestPrometheusMetrics · `test_set_sovereign_score`

**Sheet ID:** TB-TEST-OBS-007
**Series:** Individual Test Evidence
**Test File:** `tests/test_observability.py`
**Class:** `TestPrometheusMetrics`
**Function:** `test_set_sovereign_score`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_observability.py::TestPrometheusMetrics::test_set_sovereign_score -v --tb=short
```
...
*Sheet TB-TEST-OBS-007 | TelsonBase v11.0.1 | March 8, 2026*
