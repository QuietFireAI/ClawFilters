# TB-TEST-OBS-025 - TestMQTTBus · `test_on_connect_callback`

**Sheet ID:** TB-TEST-OBS-025
**Series:** Individual Test Evidence
**Test File:** `tests/test_observability.py`
**Class:** `TestMQTTBus`
**Function:** `test_on_connect_callback`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_observability.py::TestMQTTBus::test_on_connect_callback -v --tb=short
```
...
*Sheet TB-TEST-OBS-025 | TelsonBase v11.0.1 | March 8, 2026*
