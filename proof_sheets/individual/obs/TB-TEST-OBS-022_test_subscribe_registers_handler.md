# TB-TEST-OBS-022 — TestMQTTBus · `test_subscribe_registers_handler`

**Sheet ID:** TB-TEST-OBS-022
**Series:** Individual Test Evidence
**Test File:** `tests/test_observability.py`
**Class:** `TestMQTTBus`
**Function:** `test_subscribe_registers_handler`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_observability.py::TestMQTTBus::test_subscribe_registers_handler -v --tb=short
```
...
*Sheet TB-TEST-OBS-022 | TelsonBase v11.0.1 | March 8, 2026*
