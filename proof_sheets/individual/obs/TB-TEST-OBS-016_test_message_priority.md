# TB-TEST-OBS-016 — TestAgentMessage · `test_message_priority`

**Sheet ID:** TB-TEST-OBS-016
**Series:** Individual Test Evidence
**Test File:** `tests/test_observability.py`
**Class:** `TestAgentMessage`
**Function:** `test_message_priority`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_observability.py::TestAgentMessage::test_message_priority -v --tb=short
```
...
*Sheet TB-TEST-OBS-016 | TelsonBase v11.0.1 | March 8, 2026*
