# TB-TEST-OBS-021 — TestMQTTBus · `test_connect_failure`

**Sheet ID:** TB-TEST-OBS-021
...
```bash
docker compose exec mcp_server python -m pytest tests/test_observability.py::TestMQTTBus::test_connect_failure -v --tb=short
```
...
*Sheet TB-TEST-OBS-021 | TelsonBase v11.0.1 | March 8, 2026*
