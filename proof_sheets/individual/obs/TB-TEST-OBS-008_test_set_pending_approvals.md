# TB-TEST-OBS-008 - TestPrometheusMetrics · `test_set_pending_approvals`

**Sheet ID:** TB-TEST-OBS-008
**Series:** Individual Test Evidence
**Test File:** `tests/test_observability.py`
**Class:** `TestPrometheusMetrics`
**Function:** `test_set_pending_approvals`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_observability.py::TestPrometheusMetrics::test_set_pending_approvals -v --tb=short
```
...
*Sheet TB-TEST-OBS-008 | TelsonBase v11.0.3 | March 8, 2026*
