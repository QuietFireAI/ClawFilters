# TB-TEST-OBS-013 - TestAgentMessage · `test_message_creation`

**Sheet ID:** TB-TEST-OBS-013
...
```bash
docker compose exec mcp_server python -m pytest tests/test_observability.py::TestAgentMessage::test_message_creation -v --tb=short
```
...
*Sheet TB-TEST-OBS-013 | TelsonBase v11.0.1 | March 8, 2026*
