# TB-TEST-API-001 - TestPublicEndpoints · `test_root_endpoint`

**Sheet ID:** TB-TEST-API-001
...
```bash
docker compose exec mcp_server python -m pytest tests/test_api.py::TestPublicEndpoints::test_root_endpoint -v --tb=short
```
...
*Sheet TB-TEST-API-001 | TelsonBase v11.0.3 | March 8, 2026*
