...
**Function:** `test_GIVEN_trust_progression_THEN_each_level_adds_capabilities`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_behavioral.py::TestBehavior_TrustLevelProgression::test_GIVEN_trust_progression_THEN_each_level_adds_capabilities -v --tb=short
```
...
*Sheet TB-TEST-BEH-026 | TelsonBase v11.0.1 | March 8, 2026*
