...
**Function:** `test_GIVEN_ollama_agent_THEN_skips_quarantine_as_system_agent`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_behavioral.py::TestBehavior_TrustLevelProgression::test_GIVEN_ollama_agent_THEN_skips_quarantine_as_system_agent -v --tb=short
```
...
*Sheet TB-TEST-BEH-027 | TelsonBase v11.0.3 | March 8, 2026*
