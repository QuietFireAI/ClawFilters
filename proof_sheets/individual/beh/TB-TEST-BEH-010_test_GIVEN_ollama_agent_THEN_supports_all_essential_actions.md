...
**Function:** `test_GIVEN_ollama_agent_THEN_supports_all_essential_actions`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_behavioral.py::TestBehavior_OllamaAgent_ModelManagement::test_GIVEN_ollama_agent_THEN_supports_all_essential_actions -v --tb=short
```
...
*Sheet TB-TEST-BEH-010 | TelsonBase v11.0.1 | March 8, 2026*
