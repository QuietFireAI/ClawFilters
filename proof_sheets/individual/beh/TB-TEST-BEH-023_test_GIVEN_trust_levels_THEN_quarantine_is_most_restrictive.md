...
**Function:** `test_GIVEN_trust_levels_THEN_quarantine_is_most_restrictive`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_behavioral.py::TestBehavior_TrustLevelProgression::test_GIVEN_trust_levels_THEN_quarantine_is_most_restrictive -v --tb=short
```
...
*Sheet TB-TEST-BEH-023 | TelsonBase v11.0.1 | March 8, 2026*
