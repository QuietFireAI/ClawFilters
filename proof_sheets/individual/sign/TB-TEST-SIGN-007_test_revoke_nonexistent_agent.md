# TB-TEST-SIGN-007 - TestAgentKeyRegistry · `test_revoke_nonexistent_agent`

**Sheet ID:** TB-TEST-SIGN-007
**Series:** Individual Test Evidence
**Test File:** `tests/test_signing.py`
**Class:** `TestAgentKeyRegistry`
**Function:** `test_revoke_nonexistent_agent`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_signing.py::TestAgentKeyRegistry::test_revoke_nonexistent_agent -v --tb=short
```
...
*Sheet TB-TEST-SIGN-007 | TelsonBase v11.0.3 | March 8, 2026*
