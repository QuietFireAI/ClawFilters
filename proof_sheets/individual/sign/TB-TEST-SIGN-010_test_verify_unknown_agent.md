...
**Function:** `test_verify_unknown_agent`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_signing.py::TestAgentKeyRegistry::test_verify_unknown_agent -v --tb=short
```
...
*Sheet TB-TEST-SIGN-010 | TelsonBase v11.0.3 | March 8, 2026*
