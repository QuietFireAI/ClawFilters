# TB-TEST-SIGN-011 - TestAgentKeyRegistry · `test_replay_attack_prevention`

**Sheet ID:** TB-TEST-SIGN-011
...
```bash
docker compose exec mcp_server python -m pytest tests/test_signing.py::TestAgentKeyRegistry::test_replay_attack_prevention -v --tb=short
```
...
*Sheet TB-TEST-SIGN-011 | TelsonBase v11.0.3 | March 8, 2026*
