# TB-TEST-SIGN-004 — TestAgentKeyRegistry · `test_register_agent`

**Sheet ID:** TB-TEST-SIGN-004
**Series:** Individual Test Evidence
**Test File:** `tests/test_signing.py`
**Class:** `TestAgentKeyRegistry`
**Function:** `test_register_agent`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_signing.py::TestAgentKeyRegistry::test_register_agent -v --tb=short
```
...
*Sheet TB-TEST-SIGN-004 | TelsonBase v11.0.1 | March 8, 2026*
