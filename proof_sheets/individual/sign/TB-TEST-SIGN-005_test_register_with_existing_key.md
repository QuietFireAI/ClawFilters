# TB-TEST-SIGN-005 — TestAgentKeyRegistry · `test_register_with_existing_key`

**Sheet ID:** TB-TEST-SIGN-005
**Series:** Individual Test Evidence
**Test File:** `tests/test_signing.py`
**Class:** `TestAgentKeyRegistry`
**Function:** `test_register_with_existing_key`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_signing.py::TestAgentKeyRegistry::test_register_with_existing_key -v --tb=short
```
...
*Sheet TB-TEST-SIGN-005 | TelsonBase v11.0.1 | March 8, 2026*
