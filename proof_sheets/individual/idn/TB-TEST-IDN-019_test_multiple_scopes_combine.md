# TB-TEST-IDN-019 - TestScopeMapping · `test_multiple_scopes_combine`

**Sheet ID:** TB-TEST-IDN-019
**Series:** Individual Test Evidence
**Test File:** `tests/test_identiclaw.py`
**Class:** `TestScopeMapping`
**Function:** `test_multiple_scopes_combine`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_identiclaw.py::TestScopeMapping::test_multiple_scopes_combine -v --tb=short
```
...
*Sheet TB-TEST-IDN-019 | TelsonBase v11.0.1 | March 8, 2026*
