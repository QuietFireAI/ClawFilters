# TB-TEST-IDN-005 — TestDIDParsing · `test_parse_did_no_prefix`

**Sheet ID:** TB-TEST-IDN-005
**Series:** Individual Test Evidence
**Test File:** `tests/test_identiclaw.py`
**Class:** `TestDIDParsing`
**Function:** `test_parse_did_no_prefix`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_identiclaw.py::TestDIDParsing::test_parse_did_no_prefix -v --tb=short
```
...
*Sheet TB-TEST-IDN-005 | TelsonBase v11.0.1 | March 8, 2026*
