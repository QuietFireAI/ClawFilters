# TB-TEST-IDN-008 - TestEd25519Verification · `test_valid_signature`

**Sheet ID:** TB-TEST-IDN-008
...
```bash
docker compose exec mcp_server python -m pytest tests/test_identiclaw.py::TestEd25519Verification::test_valid_signature -v --tb=short
```
...
*Sheet TB-TEST-IDN-008 | TelsonBase v11.0.3 | March 8, 2026*
