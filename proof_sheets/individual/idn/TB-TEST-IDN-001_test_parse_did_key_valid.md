# TB-TEST-IDN-001 - TestDIDParsing · `test_parse_did_key_valid`

**Sheet ID:** TB-TEST-IDN-001
**Series:** Individual Test Evidence
**Test File:** `tests/test_identiclaw.py`
**Class:** `TestDIDParsing`
**Function:** `test_parse_did_key_valid`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_identiclaw.py::TestDIDParsing::test_parse_did_key_valid -v --tb=short
```
...
*Sheet TB-TEST-IDN-001 | TelsonBase v11.0.3 | March 8, 2026*
