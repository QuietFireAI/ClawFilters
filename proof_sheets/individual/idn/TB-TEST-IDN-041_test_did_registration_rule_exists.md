# TB-TEST-IDN-041 - TestApprovalGateRules · `test_did_registration_rule_exists`

**Sheet ID:** TB-TEST-IDN-041
...
```bash
docker compose exec mcp_server python -m pytest tests/test_identiclaw.py::TestApprovalGateRules::test_did_registration_rule_exists -v --tb=short
```
