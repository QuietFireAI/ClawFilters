...
**Function:** `test_existing_rules_unaffected`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_identiclaw.py::TestApprovalGateRules::test_existing_rules_unaffected -v --tb=short
```
...
*Sheet TB-TEST-IDN-043 | TelsonBase v11.0.3 | March 8, 2026*
