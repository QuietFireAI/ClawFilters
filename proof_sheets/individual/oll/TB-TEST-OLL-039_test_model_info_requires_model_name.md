# TB-TEST-OLL-039 — TestOllamaAgentExecute · `test_model_info_requires_model_name`

**Sheet ID:** TB-TEST-OLL-039
**Series:** Individual Test Evidence
**Test File:** `tests/test_ollama.py`
**Class:** `TestOllamaAgentExecute`
**Function:** `test_model_info_requires_model_name`
**Status:** VERIFIED
...
> Model info requires model name
...
```bash
docker compose exec mcp_server python -m pytest tests/test_ollama.py::TestOllamaAgentExecute::test_model_info_requires_model_name -v --tb=short
```
...
*Sheet TB-TEST-OLL-039 | TelsonBase v11.0.1 | March 8, 2026*
