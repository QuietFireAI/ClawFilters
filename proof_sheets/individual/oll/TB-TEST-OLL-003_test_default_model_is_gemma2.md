# TB-TEST-OLL-003 — TestOllamaServiceInit · `test_default_model_is_gemma2`

**Sheet ID:** TB-TEST-OLL-003
**Series:** Individual Test Evidence
**Test File:** `tests/test_ollama.py`
**Class:** `TestOllamaServiceInit`
**Function:** `test_default_model_is_gemma2`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_ollama.py::TestOllamaServiceInit::test_default_model_is_gemma2 -v --tb=short
```
...
*Sheet TB-TEST-OLL-003 | TelsonBase v11.0.1 | March 8, 2026*
