# TB-TEST-OLL-017 - TestOllamaServiceGenerate · `test_generate_with_custom_model`

**Sheet ID:** TB-TEST-OLL-017
**Series:** Individual Test Evidence
**Test File:** `tests/test_ollama.py`
**Class:** `TestOllamaServiceGenerate`
**Function:** `test_generate_with_custom_model`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_ollama.py::TestOllamaServiceGenerate::test_generate_with_custom_model -v --tb=short
```
...
*Sheet TB-TEST-OLL-017 | TelsonBase v11.0.1 | March 8, 2026*
