# TB-TEST-OLL-038 - TestOllamaAgentExecute · `test_unknown_action_raises`

**Sheet ID:** TB-TEST-OLL-038
**Series:** Individual Test Evidence
**Test File:** `tests/test_ollama.py`
**Class:** `TestOllamaAgentExecute`
**Function:** `test_unknown_action_raises`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_ollama.py::TestOllamaAgentExecute::test_unknown_action_raises -v --tb=short
```
...
*Sheet TB-TEST-OLL-038 | TelsonBase v11.0.3 | March 8, 2026*
