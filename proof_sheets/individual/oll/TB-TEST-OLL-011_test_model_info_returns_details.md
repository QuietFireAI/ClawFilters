# TB-TEST-OLL-011 — TestOllamaServiceModels · `test_model_info_returns_details`

**Sheet ID:** TB-TEST-OLL-011
**Series:** Individual Test Evidence
**Test File:** `tests/test_ollama.py`
**Class:** `TestOllamaServiceModels`
**Function:** `test_model_info_returns_details`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_ollama.py::TestOllamaServiceModels::test_model_info_returns_details -v --tb=short
```
...
*Sheet TB-TEST-OLL-011 | TelsonBase v11.0.1 | March 8, 2026*
