...
**Function:** `test_llm_health_with_auth`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_ollama.py::TestLLMEndpoints::test_llm_health_with_auth -v --tb=short
```
...
*Sheet TB-TEST-OLL-043 | TelsonBase v11.0.1 | March 8, 2026*
