# TB-TEST-OLL-031 - TestOllamaAgentInit · `test_agent_skips_quarantine`

**Sheet ID:** TB-TEST-OLL-031
**Series:** Individual Test Evidence
**Test File:** `tests/test_ollama.py`
**Class:** `TestOllamaAgentInit`
**Function:** `test_agent_skips_quarantine`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_ollama.py::TestOllamaAgentInit::test_agent_skips_quarantine -v --tb=short
```
...
*Sheet TB-TEST-OLL-031 | TelsonBase v11.0.1 | March 8, 2026*
