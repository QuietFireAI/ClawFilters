# TB-TEST-OLL-014 — TestOllamaServiceModels · `test_delete_model_success`

**Sheet ID:** TB-TEST-OLL-014
**Series:** Individual Test Evidence
**Test File:** `tests/test_ollama.py`
**Class:** `TestOllamaServiceModels`
**Function:** `test_delete_model_success`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_ollama.py::TestOllamaServiceModels::test_delete_model_success -v --tb=short
```
...
*Sheet TB-TEST-OLL-014 | TelsonBase v11.0.1 | March 8, 2026*
