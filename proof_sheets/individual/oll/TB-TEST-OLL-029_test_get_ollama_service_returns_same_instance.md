...
**Class:** `TestSingleton`
**Function:** `test_get_ollama_service_returns_same_instance`
**Status:** VERIFIED
...
> Get ollama service returns same instance
...
```bash
docker compose exec mcp_server python -m pytest tests/test_ollama.py::TestSingleton::test_get_ollama_service_returns_same_instance -v --tb=short
```
...
*Sheet TB-TEST-OLL-029 | TelsonBase v11.0.1 | March 8, 2026*
