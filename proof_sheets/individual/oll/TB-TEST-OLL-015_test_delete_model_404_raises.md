# TB-TEST-OLL-015 - TestOllamaServiceModels · `test_delete_model_404_raises`

**Sheet ID:** TB-TEST-OLL-015
**Series:** Individual Test Evidence
**Test File:** `tests/test_ollama.py`
**Class:** `TestOllamaServiceModels`
**Function:** `test_delete_model_404_raises`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_ollama.py::TestOllamaServiceModels::test_delete_model_404_raises -v --tb=short
```
...
*Sheet TB-TEST-OLL-015 | TelsonBase v11.0.1 | March 8, 2026*
