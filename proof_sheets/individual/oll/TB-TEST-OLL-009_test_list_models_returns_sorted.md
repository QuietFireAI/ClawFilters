# TB-TEST-OLL-009 — TestOllamaServiceModels · `test_list_models_returns_sorted`

**Sheet ID:** TB-TEST-OLL-009
**Series:** Individual Test Evidence
**Test File:** `tests/test_ollama.py`
**Class:** `TestOllamaServiceModels`
**Function:** `test_list_models_returns_sorted`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_ollama.py::TestOllamaServiceModels::test_list_models_returns_sorted -v --tb=short
```
...
*Sheet TB-TEST-OLL-009 | TelsonBase v11.0.1 | March 8, 2026*
