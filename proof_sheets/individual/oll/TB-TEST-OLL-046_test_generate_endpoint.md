# TB-TEST-OLL-046 - TestLLMEndpoints · `test_generate_endpoint`

**Sheet ID:** TB-TEST-OLL-046
...
```bash
docker compose exec mcp_server python -m pytest tests/test_ollama.py::TestLLMEndpoints::test_generate_endpoint -v --tb=short
```
...
*Sheet TB-TEST-OLL-046 | TelsonBase v11.0.1 | March 8, 2026*
