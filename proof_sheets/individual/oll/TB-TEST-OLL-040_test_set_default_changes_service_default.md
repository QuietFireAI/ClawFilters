...
> Set default changes service default
...
```bash
docker compose exec mcp_server python -m pytest tests/test_ollama.py::TestOllamaAgentExecute::test_set_default_changes_service_default -v --tb=short
```
