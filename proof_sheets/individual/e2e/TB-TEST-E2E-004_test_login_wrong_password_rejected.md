# TB-TEST-E2E-004 - TestUserLifecycle · `test_login_wrong_password_rejected`

**Sheet ID:** TB-TEST-E2E-004
...
```bash
docker compose exec mcp_server python -m pytest tests/test_e2e_integration.py::TestUserLifecycle::test_login_wrong_password_rejected -v --tb=short
```
