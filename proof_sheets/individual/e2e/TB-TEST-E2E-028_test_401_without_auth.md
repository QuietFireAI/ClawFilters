# TB-TEST-E2E-028 — TestErrorSanitization · `test_401_without_auth`

**Sheet ID:** TB-TEST-E2E-028
**Series:** Individual Test Evidence
**Test File:** `tests/test_e2e_integration.py`
**Class:** `TestErrorSanitization`
**Function:** `test_401_without_auth`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_e2e_integration.py::TestErrorSanitization::test_401_without_auth -v --tb=short
```
...
*Sheet TB-TEST-E2E-028 | TelsonBase v11.0.1 | March 8, 2026*
