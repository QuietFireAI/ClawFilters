# TB-TEST-E2E-020 — TestSecurityEndpoints · `test_captcha_wrong_answer_blocks_registration`

**Sheet ID:** TB-TEST-E2E-020
...
> Captcha wrong answer blocks registration
...
```bash
docker compose exec mcp_server python -m pytest tests/test_e2e_integration.py::TestSecurityEndpoints::test_captcha_wrong_answer_blocks_registration -v --tb=short
```
