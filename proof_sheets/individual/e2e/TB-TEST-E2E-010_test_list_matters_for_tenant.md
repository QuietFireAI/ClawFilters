# TB-TEST-E2E-010 - TestTenantWorkflow · `test_list_matters_for_tenant`

**Sheet ID:** TB-TEST-E2E-010
**Series:** Individual Test Evidence
**Test File:** `tests/test_e2e_integration.py`
**Class:** `TestTenantWorkflow`
**Function:** `test_list_matters_for_tenant`
**Status:** VERIFIED
...
```bash
docker compose exec mcp_server python -m pytest tests/test_e2e_integration.py::TestTenantWorkflow::test_list_matters_for_tenant -v --tb=short
```
...
*Sheet TB-TEST-E2E-010 | TelsonBase v11.0.3 | March 8, 2026*
