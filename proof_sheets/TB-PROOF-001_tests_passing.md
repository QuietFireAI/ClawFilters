...
**Claim Source:** telsonbase.com - Hero Section / README.md
**Status:** VERIFIED
...
| `test_compliance_routes_depth.py` | 113 | Compliance API routes depth |
| `test_coverage_boost.py` | 106 | Coverage boost (misc modules) |
| `test_toolroom_registry_depth.py` | 105 | Toolroom registry depth |
| `test_agents_compliance_check_agent_depth.py` | 103 | Compliance check agent depth |
| `test_agents_doc_prep_depth.py` | 101 | Document preparation agent depth |
...
| `test_ollama_service_depth.py` | 88 | Ollama service depth (omitted from coverage gate) |
...
| `test_openclaw_routes_depth.py` | 71 | OpenClaw API routes depth |
| `test_core_mqtt_bus_depth.py` | 70 | MQTT bus depth coverage |
| `test_coverage_boost2.py` | 70 | Coverage boost (misc modules) |
| `test_toolroom_cage_depth.py` | 69 | Toolroom cage depth coverage |
...
| `test_core_config_depth.py` | 53 | Core config depth coverage |
| `test_identiclaw_depth.py` | 53 | Identiclaw DID depth coverage |
...
| `test_ollama_agent_depth.py` | 43 | Ollama agent depth (omitted from coverage gate) |
...
| `test_core_models_depth.py` | 38 | Core models depth coverage |
| `test_core_metrics_depth.py` | 36 | Metrics depth |
| `test_identiclaw_routes_depth.py` | 36 | Identiclaw API routes depth |
...
| `test_core_email_sender_depth.py` | 16 | Email sender depth coverage |
| `test_capabilities.py` | 15 | Capability profiles and declarations |
| `test_signing.py` | 13 | RSA/Ed25519 payload signing |
| `test_core_database_depth.py` | 12 | Core database depth coverage |
...
*Sheet TB-PROOF-001 | TelsonBase v11.0.3 | March 20, 2026*
