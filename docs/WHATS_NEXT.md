...
OpenClaw is a third-party OpenClaw agent. TelsonBase's governance proxy code (`core/openclaw.py`) wraps it at the MCP layer - every action evaluated through the 8-step pipeline before execution. OpenClaw itself is never modified. The claw doesn't know it's on a leash.
...
*TelsonBase v11.0.3 · March 20, 2026 · Quietfire AI*
