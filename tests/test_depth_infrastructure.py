...
class TestNoCloudDependencies:
    ...
    def test_requirements_txt_has_no_cloud_packages(self):
        ...
        assert not violations, (
            ...
            "TelsonBase must have zero cloud API SDK dependencies."
        )
